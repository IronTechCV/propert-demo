...
def run_detector(detector, path):
  ...
  stair_choices = ["Ads / business notices near staircase",
                   "The staircase is obstructed",
                   "There are no handrails",
                   "Is my staircase safe for fire escape?"]

  stair_report_tar = ["Building Manager (email: buildingmanager@building.com)",
                      "Building Manager (email: buildingmanager@building.com)",
                      "Building Authority (email: enquiry@bd.gov.hk)",
                      "Building Authority (email: enquiry@bd.gov.hk)"]

  if b'Stairs' in all_objs:
    print("Stairs")

    for i in range(len(stair_choices)):
      print(str(i+1) + '. ' + stair_choices[i])
  ...
  window_report_tar = ["Building Manager (email: buildingmanager@building.com)",
                      "Building Manager (email: buildingmanager@building.com)",
                      "Building Authority (email: enquiry@bd.gov.hk)"]
  ...
  if b'Window' in all_objs:
    ...
    for i in range(len(window_choices)):
      print(str(i+1) + '. ' + window_choices[i])
  ...
  pet_choices = ['Nuisance or danger to health by pets',
                 'My neighbours are keeping pets']

  pet_report_tar = ['Food and Environmental Hygiene Department (enquiries@fehd.gov.hk)',
                    'Building Manager (email: buildingmanager@building.com)']

  reg_pets = ["Nuisances which may be dealt with summarily (d) any animal or bird kept in such a place, or in such a manner, as to be a nuisance or injurious or dangerous to health; (1)The following matters shall, subject as hereinafter provided, be nuisances which may be dealt with summarily under section 127—\n\n",
  ...
  if b'Dog' in all_objs or b'Cat' in all_objs:
    print('Pets')  
    for i in range(len(pet_choices)):
      print(str(i+1) + '. ' + pet_choices[i])
